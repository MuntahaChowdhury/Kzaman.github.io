...
export default function ContactPage() {
    return (
        <div className="pb-10 min-h-screen">
            ...
            {/* Boxes */}
            <div className="grid grid-cols-5 my-3 w-fit gap-8 mx-auto -translate-y-1/3">
                <div></div>
                <div className="p-4 w-52 altbody flex flex-col items-center justify-start space-y-3">
                ...
                <div className="pl-4 w-52 flex flex-col justify-end space-y-3">
            ...
            <div className="grid grid-cols-[1.5fr_1fr] gap-6 px-10">
                {/* Form */}
                ...
                <section className="grid grid-rows-2 gap-6">
                    ...
                    <div className="flex gap-2 justify-end items-start gap-4">
                        <button className="bg-cta  text-lg rounded-3xl py-2 px-8 h-fit">View in Browser</button>
                        <button className="altbody text-lg rounded-3xl py-2 px-8 h-fit">Download PDF</button>
                    </div>
                </section>
            </div>
