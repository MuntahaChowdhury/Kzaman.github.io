...
export default function SkillSummary() {
    return (
        <section className="py-12 px-16">
            ...
            <div className="grid grid-cols-3 gap-16 mt-5 px-5">
                ...
                <div className="p-4 pb-0 bg-black/5 overflow-y-hidden">
                    ...
                    <div className="relative grid grid-cols-[1fr_4fr] auto-rows-[1fr] gap-y-4">
                        ...
                        {/* ----------------------------------- */}
                        <div className="rounded-full w-10 h-10 bg-cards"></div>
                        <div className="mt-1 bg-buttons px-3 py-1 font-head rounded-3xl cursor-pointer hover:brightness-70 hover:outline-offset-3 hover:outline-2 outline-buttons duration-100 text-background w-fit h-fit"> See More </div>
                ...
                <div className="p-4 pb-0 overflow-y-hidden">
                    ...
                    <div className="relative grid grid-cols-[1fr_4fr] auto-rows-[1fr] gap-y-4">
                        ...
                        {/* ----------------------------------- */}
                        <div className="rounded-full w-10 h-10 bg-headers"></div>
                        <div className="mt-1 bg-cta px-3 py-1 font-head rounded-3xl cursor-pointer hover:brightness-70 hover:outline-offset-3 hover:outline-2 outline-cta duration-100 text-foreground w-fit h-fit"> See More </div>
                ...
                <div className="p-4 grid grid-cols-1 grid-rows-2">
                    <div className="">
                        ...
                        <div className="mt-3 bg-cards px-3 py-1 font-head rounded-3xl cursor-pointer hover:brightness-70 hover:outline-offset-3 hover:outline-2 outline-cards duration-100 text-foreground w-fit h-fit"> See More </div>
                    </div>
                    ...
                    <div className="mt-5 flex flex-col gap-3">
                        ...
                        <div className="mt-3 bg-headers px-3 py-1 font-head rounded-3xl cursor-pointer hover:brightness-70 hover:outline-offset-3 hover:outline-2 outline-headers duration-100 text-background w-fit h-fit"> See More </div>
                    </div>
                </div>
            </div>
